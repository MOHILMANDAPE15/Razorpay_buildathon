      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-slate-200 pb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 mt-1 max-w-3xl leading-relaxed">
                Sliding-window binomial Z-score and CUSUM change-point detector tracking live checkout scoring events.
                Triggers autonomous background adaptation when fraud distribution shifts significantly.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2.5">
          <button
            ...
            className={`px-3.5 py-2 text-xs font-bold rounded-xl border transition-all flex items-center gap-2 shadow-xs ${
              autoRefresh 
          ...
          <button
            onClick={loadData}
            className="px-3.5 py-2 text-xs font-bold rounded-xl bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 shadow-xs transition flex items-center gap-1.5"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className={`p-5 rounded-2xl border transition-all shadow-xs ${
          ...
          <div className="mt-3 flex items-baseline gap-2">
            ...
            <span className="text-xs text-slate-500 font-mono">
              ({snapshot?.total_orders_processed || 0} total)
            </span>
          </div>
        ...
        <div className="p-5 rounded-2xl border border-slate-200/90 bg-white shadow-xs">
          ...
          <p className="text-xs text-slate-500 mt-2">
            Sliding window size: <span className="font-mono font-bold text-slate-800">{snapshot?.window_size || 50}</span> orders
          </p>
        </div>
          ...
          <div className="p-6 rounded-2xl border border-slate-200 bg-white shadow-sm space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-base font-bold text-slate-900 flex items-center gap-2">
                  <TrendingUp className="w-4 h-4 text-indigo-600" />
                  Rolling Flag Rate Trajectory (Last 40 Events)
                </h3>
                <p className="text-xs text-slate-500">
                  Solid cyan line shows rolling flag rate; dashed green line is baseline (8.0%); red threshold is upper 2.5σ bound.
                </p>
              </div>
            ...
            <div className="h-56 w-full bg-slate-50 border border-slate-200 rounded-xl p-4 relative overflow-hidden flex flex-col justify-end">
              ...
              <div className="flex items-center justify-between text-[10px] text-slate-500 border-t border-slate-200 pt-2 font-mono">
                ...
                <span>Sliding Window: 50 orders</span>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 rounded-2xl border border-slate-200 bg-white shadow-sm space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <button
                ...
                className="p-4 rounded-xl border border-emerald-200 bg-emerald-50/40 hover:bg-emerald-50/80 text-left transition-all group disabled:opacity-50 shadow-xs"
              >
              ...
              <button
                ...
                className="p-4 rounded-xl border border-rose-200 bg-rose-50/40 hover:bg-rose-50/80 text-left transition-all group disabled:opacity-50 shadow-xs"
              >
                <div className="flex items-center justify-between mb-1">
