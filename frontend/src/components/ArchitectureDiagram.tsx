  ...
  return (
    <div className="rounded-3xl border border-slate-200 bg-white shadow-xs p-6 sm:p-8 space-y-6 animate-fade-in font-sans relative">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 border-b border-slate-100 pb-5">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">
            Scroll vertically to follow the full defense lifecycle. Pan horizontally if needed to explore outer retry and promotion loop tracks. <strong>Click any stage</strong> for a clear plain-language breakdown.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2 text-xs text-slate-500 font-mono bg-slate-50 px-3 py-1.5 rounded-xl border border-slate-200 shrink-0">
          <span>↔ Scroll horizontally to explore full loops</span>
        </div>
      </div>
      ...
      <div className="p-4 sm:p-6 rounded-2xl bg-slate-50 border border-slate-200 overflow-x-auto shadow-inner">
        <div className="min-w-[1240px] max-w-[1300px] mx-auto relative">
          <svg
            viewBox="0 0 1200 2620"
          ...
          >
            ...
            {/* ========================================================================= */}
            {/* Right track at x = 1100 */}
            <path
              d="M 830 2345 L 1100 2345 L 1100 217 L 805 217"
            ...
            >
              ...
              <text x="0" y="14" textAnchor="middle" className="text-[10px] fill-slate-500 font-mono">
                Atomic version bump &amp; serving weights snapshot (Click details)
              </text>
            </g>
            ...
            {/* Left track at x = 190 */}
            <path
              d="M 360 1450 L 190 1450 L 190 1315 L 355 1315"
              stroke="#e11d48"
              strokeWidth="2.5"
              strokeDasharray="6 4"
              fill="none"
            ...
            {/* Left track at x = 80 */}
            <path
              d="M 360 1855 L 80 1855 L 80 1290 L 355 1290"
              stroke="#e11d48"
              strokeWidth="3"
              strokeDasharray="7 5"
              fill="none"
            ...
            {/* ========================================================================= */}
            {/* 1. New Order */}
            <g transform="translate(390, 40)" className="cursor-pointer" onClick={() => handleNodeClick('new_order')}>
                ...
                <div className="w-full h-full p-4 rounded-2xl bg-white border-2 border-slate-300 shadow-xs flex items-center justify-between hover:border-indigo-500 hover:shadow-md transition">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[9px] font-mono px-2 py-0.5 rounded-full bg-slate-100 text-slate-600 font-bold">CLICK FOR DETAILS</span>
                    </div>
            ...
            {/* Connecting line: 1 -> 2 */}
            <path d="M 600 125 L 600 167" stroke="#64748b" strokeWidth="2.5" fill="none" markerEnd="url(#v-arr-slate)" />
            <rect x="568" y="136" width="64" height="20" rx="4" fill="#ffffff" stroke="#cbd5e1" strokeWidth="1.5" />
            <text x="600" y="150" textAnchor="middle" className="text-[9.5px] fill-slate-600 font-mono font-bold">stream</text>
            ...
            <g transform="translate(370, 170)" className="cursor-pointer" onClick={() => handleNodeClick('frozen_ensemble')}>
            ...
            {/* Connecting line: 2 -> 3 */}
            <path d="M 600 265 L 600 307" stroke="#059669" strokeWidth="2.5" fill="none" markerEnd="url(#v-arr-emerald)" />
            <rect x="556" y="276" width="88" height="20" rx="4" fill="#ecfdf5" stroke="#a7f3d0" strokeWidth="1.5" />
            <text x="600" y="150" textAnchor="middle" className="text-[9.5px] fill-slate-600 font-mono font-bold" />
            <text x="600" y="290" textAnchor="middle" className="text-[9.5px] fill-emerald-800 font-mono font-bold">score (&lt;10ms)</text>
            ...
            {/* ========================================================================= */}
            {/* 3. 3-Way Router */}
            <g transform="translate(360, 310)" className="cursor-pointer" onClick={() => handleNodeClick('three_way_router')}>
            ...
            {/* Connecting line: 3 -> 4 */}
            <path d="M 600 415 L 600 457" stroke="#0284c7" strokeWidth="2.5" fill="none" markerEnd="url(#v-arr-sky)" />
            <rect x="560" y="426" width="80" height="20" rx="4" fill="#f0f9ff" stroke="#bae6fd" strokeWidth="1.5" />
            <text x="600" y="440" textAnchor="middle" className="text-[9.5px] fill-sky-800 font-mono font-bold">log actions</text>
            ...
            {/* ========================================================================= */}
            {/* 4. Outcomes */}
            <g transform="translate(380, 460)" className="cursor-pointer" onClick={() => handleNodeClick('outcome_logged')}>
            ...
            <path d="M 600 550 L 600 595" stroke="#64748b" strokeWidth="2.5" fill="none" markerEnd="url(#v-arr-slate)" />
            <rect x="520" y="563" width="160" height="20" rx="4" fill="#ffffff" stroke="#cbd5e1" strokeWidth="1.5" />
            <text x="600" y="577" textAnchor="middle" className="text-[9.5px] fill-slate-600 font-mono font-bold">mature courier ground truth</text>
            ...
            <rect x="200" y="605" width="800" height="575" rx="22" fill="#fffbeb" fillOpacity="0.4" stroke="#fde68a" strokeWidth="2" strokeDasharray="5 5" />
            <text x="225" y="633" className="text-xs font-mono font-bold fill-amber-900 uppercase tracking-wide">
              5. Autonomous Adaptation Trigger Layer (Continuous Sentinels)
            </text>

            {/* Trigger Distribution Line from Step 4 */}
            <path d="M 600 595 L 600 655" stroke="#d97706" strokeWidth="2.5" fill="none" />
            <path d="M 330 655 L 850 655" stroke="#d97706" strokeWidth="2.5" fill="none" />
            <path d="M 330 655 L 330 670" stroke="#d97706" strokeWidth="2.5" fill="none" markerEnd="url(#v-arr-amber)" />
            <path d="M 590 655 L 590 670" stroke="#d97706" strokeWidth="2.5" fill="none" markerEnd="url(#v-arr-amber)" />
            <path d="M 850 655 L 850 670" stroke="#d97706" strokeWidth="2.5" fill="none" markerEnd="url(#v-arr-amber)" />

            {/* 5A. Spike Monitor Sentinel */}
            <g transform="translate(220, 670)" className="cursor-pointer" onClick={() => handleNodeClick('spike_monitor')}>
            ...
            <g transform="translate(480, 670)" className="cursor-pointer" onClick={() => handleNodeClick('drift_detector')}>
              <foreignObject width="220" height="95">
            ...
            <g transform="translate(740, 670)" className="cursor-pointer" onClick={() => handleNodeClick('residual_miner')}>
              <foreignObject width="220" height="95">
            ...
            <path d="M 850 765 L 850 790" stroke="#d97706" strokeWidth="2" fill="none" markerEnd="url(#v-arr-amber)" />

            {/* Sub-step 1: Mature Orders */}
            <g transform="translate(740, 795)" className="cursor-pointer" onClick={() => handleNodeClick('mature_orders')}>
            ...
            <path d="M 850 849 L 850 865" stroke="#d97706" strokeWidth="1.5" fill="none" markerEnd="url(#v-arr-amber)" />

            {/* Sub-step 2: Miss Clustering */}
            <g transform="translate(740, 870)" className="cursor-pointer" onClick={() => handleNodeClick('miss_clustering')}>
              <foreignObject width="220" height="54">
            ...
            <path d="M 850 924 L 850 940" stroke="#d97706" strokeWidth="1.5" fill="none" markerEnd="url(#v-arr-amber)" />

            {/* Sub-step 3: Significance Guard */}
            <g transform="translate(740, 945)" className="cursor-pointer" onClick={() => handleNodeClick('significance_guard')}>
              <foreignObject width="220" height="54">
            ...
            <path d="M 850 999 L 850 1015" stroke="#d97706" strokeWidth="1.5" fill="none" markerEnd="url(#v-arr-amber)" />

            {/* Sub-step 4: Cooldown Check */}
            <g transform="translate(740, 1020)" className="cursor-pointer" onClick={() => handleNodeClick('cooldown_check')}>
              <foreignObject width="220" height="54">
            ...
            <path d="M 850 1074 L 850 1090" stroke="#d97706" strokeWidth="2" fill="none" markerEnd="url(#v-arr-amber)" />

            {/* Sub-step 5: Targeted Defense Agenda */}
            <g transform="translate(740, 1095)" className="cursor-pointer" onClick={() => handleNodeClick('defense_agenda')}>
            ...
            {/* Connecting lines from Spike (330) & Drift (590) & Agenda (850) into the Core Evolution Loop */}
            <path d="M 330 765 L 330 1195 L 570 1195" stroke="#0284c7" strokeWidth="1.5" strokeDasharray="4 3" fill="none" />
            <path d="M 590 765 L 590 1195" stroke="#7c3aed" strokeWidth="1.5" strokeDasharray="4 3" fill="none" />
            {/* Explicit direct connecting line from Residual Miner Agenda (850, 1155) -> Generator (600, 1260) */}
            <path d="M 850 1155 L 850 1215 L 600 1215 L 600 1255" stroke="#d97706" strokeWidth="3" fill="none" markerEnd="url(#v-arr-purple)" />
            
            <g transform="translate(600, 1215)">
            ...
            {/* ========================================================================= */}
            {/* Group container bounding box */}
            <rect x="300" y="1225" width="600" height="1320" rx="24" fill="#faf5ff" fillOpacity="0.5" stroke="#e9d5ff" strokeWidth="2" strokeDasharray="5 5" />
            <text x="325" y="1252" className="text-xs font-mono font-bold fill-purple-950 uppercase tracking-wide">
              6. Core Multi-Agent Evolution Loop &amp; Safety Verification Gates
            </text>

            {/* 6A. Generator Agent */}
            <g transform="translate(360, 1265)" className="cursor-pointer" onClick={() => handleNodeClick('generator')}>
            ...
            <path d="M 600 1355 L 600 1392" stroke="#7c3aed" strokeWidth="2.5" fill="none" markerEnd="url(#v-arr-purple)" />
            <rect x="550" y="1364" width="100" height="20" rx="4" fill="#faf5ff" stroke="#d8b4fe" strokeWidth="1.5" />
            <text x="600" y="1378" textAnchor="middle" className="text-[9.5px] fill-purple-800 font-mono font-bold">candidate AST</text>

            {/* 6B. Evaluator Agent */}
            <g transform="translate(360, 1395)" className="cursor-pointer" onClick={() => handleNodeClick('evaluator')}>
              <foreignObject width="480" height="90">
                <div className="w-full h-full p-4 rounded-2xl bg-white border-2 border-purple-500 shadow-xs flex items-center justify-between hover:border-purple-700 hover:shadow-md transition">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
            ...
            <path d="M 600 1485 L 600 1522" stroke="#7c3aed" strokeWidth="2.5" fill="none" markerEnd="url(#v-arr-purple)" />
            <rect x="558" y="1494" width="84" height="20" rx="4" fill="#faf5ff" stroke="#d8b4fe" strokeWidth="1.5" />
            <text x="600" y="1508" textAnchor="middle" className="text-[9.5px] fill-purple-800 font-mono font-bold">valid AST</text>

            {/* 6C. Reflector Agent */}
            <g transform="translate(360, 1525)" className="cursor-pointer" onClick={() => handleNodeClick('reflector')}>
              <foreignObject width="480" height="90">
                <div className="w-full h-full p-4 rounded-2xl bg-white border-2 border-purple-500 shadow-xs flex items-center justify-between hover:border-purple-700 hover:shadow-md transition">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
            ...
            <path d="M 600 1615 L 600 1652" stroke="#7c3aed" strokeWidth="2.5" fill="none" markerEnd="url(#v-arr-purple)" />
            <rect x="536" y="1624" width="128" height="20" rx="4" fill="#faf5ff" stroke="#d8b4fe" strokeWidth="1.5" />
            <text x="600" y="1638" textAnchor="middle" className="text-[9.5px] fill-purple-800 font-mono font-bold">diagnosed candidate</text>

            {/* 6D. Selector & Ensemble Pruner */}
            <g transform="translate(360, 1655)" className="cursor-pointer" onClick={() => handleNodeClick('selector')}>
              <foreignObject width="480" height="90">
                <div className="w-full h-full p-4 rounded-2xl bg-white border-2 border-purple-500 shadow-xs flex items-center justify-between hover:border-purple-700 hover:shadow-md transition">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
            ...
            <path d="M 600 1745 L 600 1782" stroke="#059669" strokeWidth="2.5" fill="none" markerEnd="url(#v-arr-emerald)" />
            <rect x="526" y="1754" width="148" height="20" rx="4" fill="#ecfdf5" stroke="#a7f3d0" strokeWidth="1.5" />
            <text x="600" y="1768" textAnchor="middle" className="text-[9.5px] fill-emerald-800 font-mono font-bold">pareto ensemble candidate</text>
            ...
            <g transform="translate(360, 1785)" className="cursor-pointer" onClick={() => handleNodeClick('regression_gate')}>
              <foreignObject width="480" height="90">
            ...
            <path d="M 600 1875 L 600 1912" stroke="#059669" strokeWidth="2.5" fill="none" markerEnd="url(#v-arr-emerald)" />
            <rect x="516" y="1884" width="168" height="20" rx="4" fill="#ecfdf5" stroke="#a7f3d0" strokeWidth="1.5" />
            <text x="600" y="1898" textAnchor="middle" className="text-[9.5px] fill-emerald-800 font-mono font-bold">regression &lt; 5% [PASS]</text>

            {/* 6F. Gate 2: Held-Out Verification Gate */}
            <g transform="translate(360, 1915)" className="cursor-pointer" onClick={() => handleNodeClick('held_out_gate')}>
              <foreignObject width="480" height="90">
                <div className="w-full h-full p-4 rounded-2xl bg-white border-2 border-emerald-500 shadow-xs flex items-center justify-between hover:border-emerald-700 hover:shadow-md transition">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
            ...
            <path d="M 600 2005 L 600 2042" stroke="#059669" strokeWidth="2.5" fill="none" markerEnd="url(#v-arr-emerald)" />
            <rect x="516" y="2014" width="168" height="20" rx="4" fill="#ecfdf5" stroke="#a7f3d0" strokeWidth="1.5" />
            <text x="600" y="2028" textAnchor="middle" className="text-[9.5px] fill-emerald-800 font-mono font-bold">validation split [PASS]</text>

            {/* 6G. Gate 3: Decoy Guard & AST Security Audit */}
            <g transform="translate(360, 2045)" className="cursor-pointer" onClick={() => handleNodeClick('decoy_guard')}>
              <foreignObject width="480" height="90">
            ...
            <path d="M 600 2135 L 600 2177" stroke="#059669" strokeWidth="3" fill="none" markerEnd="url(#v-arr-emerald)" />
            <rect x="506" y="2146" width="188" height="20" rx="4" fill="#ecfdf5" stroke="#a7f3d0" strokeWidth="1.5" />
            <text x="600" y="2160" textAnchor="middle" className="text-[9.5px] fill-emerald-800 font-mono font-bold">all gates verified [PASS]</text>
            ...
            {/* ========================================================================= */}
            {/* 7. Promoted Rule */}
            <g transform="translate(340, 2180)" className="cursor-pointer" onClick={() => handleNodeClick('promoted_ensemble')}>
            ...
            <path d="M 600 2285 L 600 2345 L 830 2345" stroke="#059669" strokeWidth="3.5" fill="none" />
            <circle cx="600" cy="2285" r="4.5" fill="#059669" />
          </svg>
        </div>
      </div>
